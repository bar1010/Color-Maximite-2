...
sub draw_2d_maze
  if screen_drawn = 0 and drawn_maze = 0 then 'just need one variable here
    ...
    if have_key = 0 then
      print @(9 * 8, 49 * 12) "Floor =";floor;"  need key ";"  Score =";score;
    elseif have_key = 1 then
      print @(9 * 8, 49 * 12) "Floor =";floor;"  found key";"  Score =";score;
    endif
    color Indigo
    screen_drawn = 1
    drawn_maze = 1
    ...
    if have_key = 0 then
      print @(16 * 8, 49 * 12) floor;"  need key ";"  Score =";score;
    elseif have_key = 1 then
      print @(16 * 8, 49 * 12) floor;"  found key";"  Score =";score;
    endif
    color Indigo
    pause 64
  endif
...
sub draw_3d_maze
  ...
  if have_key = 0 then
    print @(399, 12) ch$;space$(10);floor;"  need key ";"  Score =";score;
  elseif have_key = 1 then
    print @(399, 12) ch$;space$(10);floor;"  found key";"  Score =";score;
  endif
  pause 200
end sub
