...
pause 1500 : cls
width = 301 : height = 149 '101x51, width and height must be ODD 
...
sub draw_2d_maze
  if screen_drawn = 0 then 
    ...
    if xa < 100 and ya < 49 then 'NW screen 
      ...
      next yt
      m$(1, 1) = "u"
    elseif xa > 99 and xa < 200 and ya < 49 then 'NC screen
      for yt = 0 to 48
        for xt = 100 to 199 
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
            print m$(xt, yt);
      ...
      next yt 
    elseif xa > 199 and ya < 49 then 'NE screen
      for yt = 0 to 48
        for xt = 200 to width - 3  
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
             print m$(xt, yt);
          else
             color Yellow : print m$(xt, yt); : color Indigo
      ...
      next yt
    elseif xa < 100 and ya > 48 and ya < 98 then 'CW screen
      for yt = 49 to 97
        for xt = 0 to 99
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
            print m$(xt, yt);
      ...
      next yt
    elseif xa > 99 and xa < 200 and ya > 48 and ya < 98 then 'CC screen
      for yt = 49 to 97 
        for xt = 100 to 199 
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
            print m$(xt, yt);
      ...
      next yt
    elseif xa > 199 and ya > 48 and ya < 98 then 'CE screen
      for yt = 49 to 97
        for xt = 200 to width - 3  
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
             print m$(xt, yt);
      ...
      next yt
    elseif xa < 100 and ya > 97 then 'SW screen
      for yt = 98 to height - 3
        for xt = 0 to 99  
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
             print m$(xt, yt);
          else
      ...
      next yt
    elseif xa > 99 and xa < 200 and ya > 97 then 'SC screen
      for yt = 98 to height - 3
        for xt = 100 to 199
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
             print m$(xt, yt);
      ...
      next yt
    elseif xa > 199 and ya > 97 then 'SE screen    
      for yt = 98 to height - 3
        for xt = 200 to width - 3
          if m$(xt, yt) <> "x" and m$(xt, yt) <> "u" and m$(xt, yt) <> "d" then
             print m$(xt, yt);
